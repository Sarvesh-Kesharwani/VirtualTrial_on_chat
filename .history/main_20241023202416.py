...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text('Send me an image containing image ')

async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text('You send and image file then tell me weather its a "Person" or "Garment". then i\'ll provide the modified image')
